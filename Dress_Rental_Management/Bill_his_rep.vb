...
Public Class Bill_his_rep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Dress_Rental_Management.Bill_his_rep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBill_his_rep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Bill_his_rep = New Bill_his_rep()
        rpt.Site = Me.Site
        Return rpt
    End Function
