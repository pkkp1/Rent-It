...
Public Class BillReptCst
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Dress_Rental_Management.BillReptCst.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBillReptCst
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BillReptCst = New BillReptCst()
        rpt.Site = Me.Site
        Return rpt
    End Function
