...
Public Class BillReptEmp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Dress_Rental_Management.BillReptEmp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBillReptEmp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BillReptEmp = New BillReptEmp()
        rpt.Site = Me.Site
        Return rpt
    End Function
