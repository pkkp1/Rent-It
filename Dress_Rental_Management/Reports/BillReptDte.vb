...
Public Class BillReptDte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Dress_Rental_Management.BillReptDte.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBillReptDte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BillReptDte = New BillReptDte()
        rpt.Site = Me.Site
        Return rpt
    End Function
